...
void ClipperOffset::ExecuteConst(Paths& solution, double delta, int step)
{
	solution.clear();
	FixOrientations();
...
void ClipperOffset::DoConstOffset(double delta, int in_step)
{
	m_destPolys.clear();
	m_delta = delta;
...
void ClipperOffset::DoOffset(double delta, int in_step)
{
  m_destPolys.clear();
  m_delta = delta;
